...
class ILI9341:
    ...
    def printSensordata(self, fontPath, pmT=(0,0), pm25=(0,0), pm1=(0,0), pm10=(0,0),  pmH=(0,0), imagePath=""):
        # get an image
        base = Image.open(imagePath).convert('RGBA')
        ...
        d.text((posX[0],posY[1]), str(pmT[0]), font=fnt_data, fill=(255,255,255,255))
        d.text((posX[0],posY[2]), str(pmH[0]), font=fnt_data, fill=(255,255,255,255))
        d.text((posX[1],posY[0]), str(pm1[1]), font=fnt_data, fill=(255,255,255,255))
        d.text((posX[1],posY[1]), str(pm25[1]), font=fnt_data, fill=(255,255,255,255))
        d.text((posX[1],posY[2]), str(pm10[1]), font=fnt_data, fill=(255,255,255,255))
